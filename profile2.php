...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
								...
								
	{
			...
			(user_name,email,password,gender,contact,role_id,area_id,address)values
			('".$uname."','".$email."','".$pass."','".$gen."','".$con."',2,'".$area_id."' 
			,'".$add."')";
			echo $sql;
			$die;
			...
			<div id="main">
							...
							<div class="col-md-6">
								<h3>Profile picture</h3>
									...
									<div class="gallery-image">
										<a href="images/gallery/gallery_3_large.jpg" data-rel="prettyPhoto[gallery]">
				...
				<form method="post">
							<div class="col-md-6">
                                    ...
                                    <div class="row">
										<div class="col-md-6">
											...
											<div class="form-wrap">
												...
												<span style="color: red"><?php echo $msg5; $msg9; ?></span>
								...
								<?php if($r1['city_id']==$r1['city_id'])
								{echo "selected";}?>>
								
								<?php echo $r1['city_name'];?>
								</option>
